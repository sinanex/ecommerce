  ...
  return (
    <div className="min-h-screen bg-brand-surface text-brand-on-surface pt-20 pb-16">
      <>
        ...
        <meta name="description" content="View your premium shoes and sports training footwear in your shopping cart. Fast and secure checkout with free shipping over ₹1000." />
